...
bool
is_smaller(struct list_elem *a, struct list_elem *b){
...
timer_sleep (int64_t ticks)
{
    ...
    list_insert_ordered(&sleep_list, &current_thread -> elem, is_smaller , NULL);
...
///////////////////////////////////////////
    while(!list_empty(&sleep_list)){
        ...
        if(front_thread-> wakeup_ticks <= timer_ticks()){
